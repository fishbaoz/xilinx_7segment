...
*/
//wire Clk24In;
wire [31:0] lpc_port_reg;

leds_7seg_controller leds_7seg_controller_inst(
//  .debug			(),
  .IntClk		(FPGA_LPC_CLK),
//  .Reset			(1'b0),//(Reset),
  .data			(lpc_port_reg[15:0]),//(led_bus_4char),
  // LED Outputs
  .LedSeg_1		(LED_SEG_1),
  .LedSeg_2		(LED_SEG_2)
//  .LedSeg_3		(LED_SEG_3),
...
/*
leds_7seg_controller leds_7seg_controller_inst2(
//  .debug			(),
  .IntClk		(FPGA_LPC_CLK),
  .Reset			(1'b0),//(Reset),
  .data			(lpc_port_reg[7:4]),//(led_bus_4char),
  // LED Outputs
  .LedSeg		(LED_SEG_2)
//  .LedSeg_2		(LED_SEG_2),
//  .LedSeg_3		(LED_SEG_3),
...
leds_7seg_controller leds_7seg_controller_inst3(
//  .debug			(),
  .IntClk		(FPGA_LPC_CLK),
  .Reset			(1'b0),//(Reset),
  .data			(lpc_port_reg[12:8]),//(led_bus_4char),
  // LED Outputs
  .LedSeg		(LED_SEG_3)
//  .LedSeg_2		(LED_SEG_2),
//  .LedSeg_3		(LED_SEG_3),
